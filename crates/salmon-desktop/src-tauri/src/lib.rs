...
pub fn run() {
    ...
    tauri::Builder::default()
        ...
        .invoke_handler(tauri::generate_handler![
            ...
            commands::session_action,
            commands::desktop_control,
            commands::quit_app,
            commands::open_link,
            ...
            commands::get_desktop_appearance,
            commands::set_desktop_wallpaper,
            commands::set_desktop_wallpaper_image,
            commands::set_desktop_wallpaper_fit,
            commands::set_desktop_wallpaper_slideshow,
            commands::set_desktop_theme,
            commands::set_desktop_accent,
            commands::set_desktop_gtk_theme,
            commands::set_desktop_icon_theme,
            commands::set_desktop_cursor_theme,
            commands::set_desktop_font_family,
            commands::set_desktop_text_scaling_factor,
            ...
            commands::list_desktop_items,
            commands::open_path,
            commands::create_desktop_folder,
            commands::create_desktop_file,
            ...
            commands::list_input_methods,
            commands::set_input_method,
            commands::list_clipboard_history,
            commands::restore_clipboard_history,
            commands::list_workspaces,
            commands::switch_workspace,
            commands::move_focused_window_to_workspace,
            commands::take_screenshot,
            commands::list_bluetooth_devices,
            commands::set_bluetooth_device_connected,
            commands::list_display_outputs,
            commands::list_printers,
            commands::set_printer_enabled,
            commands::cancel_printer_jobs,
            commands::get_vpn_status,
            commands::set_vpn_connection_active,
            commands::get_accessibility_status,
            commands::set_accessibility_feature,
            commands::get_night_light_status,
            commands::set_night_light,
            commands::restore_night_light,
            commands::get_notification_status,
            commands::set_notification_do_not_disturb,
            commands::get_power_status,
            commands::set_power_profile,
            commands::list_storage_volumes,
            commands::mount_storage_volume,
            commands::unmount_storage_volume,
            commands::power_off_storage_volume,
            commands::open_storage_volume,
            commands::set_display_output_enabled,
            commands::set_display_output_position,
            commands::set_display_output_mode,
            commands::set_display_output_scale,
            commands::set_display_output_transform,
            commands::save_display_profile,
            commands::list_display_profiles,
            commands::delete_display_profile,
            commands::apply_display_profile,
            commands::rename_display_profile,
            commands::get_system_app_status,
            commands::list_external_windows,
            commands::focus_external_window,
            commands::minimize_external_window,
            commands::maximize_external_window,
            commands::fullscreen_external_window,
            commands::close_external_window,
            commands::launch_system_app,
            commands::list_desktop_apps,
