...
install -d "$PKG_DIR/usr/share/salmon-desktop/waybar"
install -d "$PKG_DIR/usr/share/xdg-desktop-portal"
install -d "$PKG_DIR/usr/bin"
install -d "$PKG_DIR/etc/salmon-desktop"
...
install -m 0755 "$PACKAGING_DIR/salmon-brightness" "$PKG_DIR/usr/bin/salmon-brightness"
install -m 0755 "$PACKAGING_DIR/salmon-screenshot" "$PKG_DIR/usr/bin/salmon-screenshot"
install -m 0755 "$PACKAGING_DIR/salmon-desktop-doctor" "$PKG_DIR/usr/bin/salmon-desktop-doctor"
install -m 0755 "$PACKAGING_DIR/salmon-display-profile-init" "$PKG_DIR/usr/bin/salmon-display-profile-init"
install -m 0755 "$PACKAGING_DIR/salmon-input-toggle" "$PKG_DIR/usr/bin/salmon-input-toggle"
install -m 0755 "$PACKAGING_DIR/salmon-open-browser" "$PKG_DIR/usr/bin/salmon-open-browser"
install -m 0755 "$PACKAGING_DIR/salmon-open-files" "$PKG_DIR/usr/bin/salmon-open-files"
install -m 0755 "$PACKAGING_DIR/salmon-open-terminal" "$PKG_DIR/usr/bin/salmon-open-terminal"
install -m 0755 "$PACKAGING_DIR/salmon-session-action" "$PKG_DIR/usr/bin/salmon-session-action"
install -m 0644 "$PACKAGING_DIR/swaylock.conf" "$PKG_DIR/etc/salmon-desktop/swaylock.conf"
...
install -m 0644 "$PACKAGING_DIR/labwc-config/menu.xml" "$PKG_DIR/usr/share/salmon-desktop/labwc-config/menu.xml"
install -m 0644 "$PACKAGING_DIR/labwc-config/rc.xml" "$PKG_DIR/usr/share/salmon-desktop/labwc-config/rc.xml"
install -m 0644 "$PACKAGING_DIR/waybar/tray.jsonc" "$PKG_DIR/usr/share/salmon-desktop/waybar/tray.jsonc"
install -m 0644 "$PACKAGING_DIR/waybar/tray.css" "$PKG_DIR/usr/share/salmon-desktop/waybar/tray.css"
install -m 0644 "$PACKAGING_DIR/xdg-desktop-portal/salmonapp-portals.conf" "$PKG_DIR/usr/share/xdg-desktop-portal/salmonapp-portals.conf"
install -m 0644 "$PACKAGING_DIR/xdg-desktop-portal/salmonapp-portals.conf" "$PKG_DIR/usr/share/xdg-desktop-portal/SalmonApp-portals.conf"
